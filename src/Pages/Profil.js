            ...
            <div className="grid grid-cols-1 md:grid-cols-4 items mt-16 mb-28 mx-12 md:mx-28 font-poppins">
                <div className="box-border bg-white w-full h-auto mb-8 md:mb-0 md:w-52 md:h-60 drop-shadow-md rounded-xl">
                    ...
                    <ul className="mx-6 my-4 justify-between text-sm">
                        <li className="mb-3 font-semibold"><a href="">Akun Saya</a></li>
                ...
                <div className="container md:col-start-2 md:col-span-4 box-border bg-white w-110 h-auto border rounded-lg justify-between py-8 px-12 shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4">
                        <div className="mt-8 mx-auto md:mx-0">
                            <img src="gambar_profil.png" className="rounded-full w-28 h-28 object-cover"></img>
                    ...
                    <div className="md:justify-end flex justify-center mt-6">
                        <button className="py-2 md:px-6 md:w-auto w-full rounded-full bg-secondary text-white font-poppins text-md font-bold text-center hover:bg-secondarydark">Simpan</button>
                    </div>
                </div>
            </div>
        </>
